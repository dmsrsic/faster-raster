...
SCRIPT_PATH = Path("/home/dmsrsic/raster-work/faster-raster/scripts/daymet_single_pixel_probe.py")
SPEC_PATH = Path("/home/dmsrsic/raster-work/faster-raster/research/daymet_single_pixel_probe_spec.yaml")
